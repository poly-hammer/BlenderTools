...
[import settings](https://joshquake.github.io/BlenderTools/send2ue/settings/import.html) must be turned on.
...
::: tip Note
A binding asset can only be created when the groom's surface mesh is a [skeletal mesh](https://joshquake.github.io/BlenderTools/send2ue/asset-types/skeletal-mesh.html).
:::
